...
@implementation yingdaoController
...
static NSString *controllerC = @"YingdaoController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Yingdao addSubUMView:_viewPage0];
     //设置控件基本属性
...
[_flipperdefine0 addView:_panel0];
    ...
    [UMCompatible initCommonProperty:_panel0 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          ...
                          @"yingdao1.png",@"backgroundImagePath",
                          [UIColor clearColor],@"background_color_dis",
                          @"",@"border-top-style",
                          @"",@"border-top-width",
                          @"",@"border-top-color",
...
[_flipperdefine0 addView:_panel1];
    ...
    [UMCompatible initCommonProperty:_panel1 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          ...
                          @"",@"color",
                          [UIColor clearColor],@"backgroundColor",
                          @"yingdao2.png",@"backgroundImagePath",
                          [UIColor clearColor],@"background_color_dis",
                          @"",@"border-top-style",
                          @"",@"border-top-width",
                          @"",@"border-top-color",
...
[_flipperdefine0 addView:_panel2];
    ...
    [UMCompatible initCommonProperty:_panel2 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          ...
                          @"",@"color",
                          [UIColor clearColor],@"backgroundColor",
                          @"yingdao3.png",@"backgroundImagePath",
                          [UIColor clearColor],@"background_color_dis",
                          @"",@"border-top-style",
                          @"",@"border-top-width",
                          @"",@"border-top-color",
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_panel4 addSubUMXView:_label0];
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.button0_onclick()" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"button1_onclick" method:@"this.button3_onclick()" sender:sender]];
